...
def create_manual_receipt_collection(auth_token, tenant_id, property_id, assessment_year, paid_by, payment_amount_map: dict
    ...
    if consumer_codes:
        ...
        return create_manual_receipt_collection(auth_token, tenant_id, property_id, assessment_year, paid_by,
                                                payment_amount_map, g8_receiptnumber, g8_receiptdate, total_amount_paid, payment_type)
    ...
    if amount_paid != total_amount_paid:
        raise Exception("Total paid calculated and actual is different. Calculated={} and Actual={}".format(amount_paid, total_amount_paid))
...
if __name__ == "__main__":
    ...
    print(.o(auth_token, "pb.testing", "PT-1012-072874", "2017-18", "Tarun", amounts,"20992/43",
