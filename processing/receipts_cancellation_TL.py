...
numbers = [
    ('PT/1603/2018-19/000578', 'PT-1603-046860'),
]
    ...
    if len(receipts) > 0:
        ...
        for receipt in receipts:
            ...
            if receipt_propertyid != propertyid:
                print("Property ID mismatch for receiptnumber={}, Expected={}, Actual={}".format(receiptNumber,receipt_propertyid, propertyid))
                continue
            ...
            proprties = search_property(auth_token, tenantid, propertyid)
            if "Properties" in proprties:
                property = proprties["Properties"]
            else:
            ...
            if len(property) > 0:
                ...
                data = cancel_receipt(auth_token, receiptNumber, receipt_consumercode,
                                      "Receipt cancellation based on PI-3863")
