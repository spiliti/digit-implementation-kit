...
def download_boundary(tenant, boundary_type):
    ...
    tenants = ["pb.adampur", "pb.alawalpur", "pb.amritsar", "pb.bathinda", "pb.hoshiarpur", "pb.jagraon",
               ...
               "pb.dharamkot", "pb.mansa", "pb.sunam", "pb.rajasansi", "pb.talwandibhai","pb.testing"]
    for t in tenants:
